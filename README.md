...
### Đỗ Tú Anh (MSV: `2A202601272`)
- **Phụ trách thiết kế Option C (AI Initiates, User Reviews):** Xây dựng cơ chế phát hiện ghi chú thiếu bối cảnh, tạo bộ tài liệu khôi phục và đề xuất nhờ bạn học/trợ giảng hỗ trợ khi AI chưa chắc chắn.
- **Xây dựng Shared Context & Content Fixture:** Cùng nhóm thiết kế bộ ghi chú mẫu môn Học máy (Machine Learning) gồm 3 từ khóa vắn tắt (_Gradient Descent, Bayes, Decision Tree_) dùng chung cho cả 3 phương án.
- **Facilitation & Observation (Phiên 1):** Trực tiếp đóng vai Facilitator thực hiện phiên phỏng vấn thử nghiệm prototype 20 phút với **Tester 1 (`2A202601870`)**, quan sát thực tế hành vi người dùng mà không giải thích giao diện hộ.
...
- **Phiên 1 (Đỗ Tú Anh test `2A202601870`):** Tester ưu tiên chọn Option B vì muốn có sẵn bản nháp tóm tsắt kèm link trích dẫn nguồn rõ ràng để đỡ tốn công tự viết lại.
